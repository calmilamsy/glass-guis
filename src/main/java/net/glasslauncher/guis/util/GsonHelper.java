...
public class GsonHelper {
   ...
   public static ItemBase convertToItem(JsonElement jsonElement, String string) {
      if (jsonElement.isJsonPrimitive()) {
         String string2 = jsonElement.getAsString();
         return ItemRegistry.INSTANCE.getByIdentifier(Identifier.of(string2)).orElseThrow(() -> {
   ...
   public static ItemBase getAsItem(JsonObject jsonObject, String string) {
      if (jsonObject.has(string)) {
